...
async def create_book(book: BookCreate, session: AsyncSession = Depends(get_session)) -> BookOut:
    """Create a new book"""
...
async def delete_book(book_uuid: uuid.UUID, session: AsyncSession = Depends(get_session)) -> None:
