"""
V2 User Routes with Pagination

Enhanced user endpoints with:
...
@user_router.get(
    "/",
    response_model=PaginatedResponse[ShowUser],
    status_code=status.HTTP_200_OK,
...
async def get_all_users(
        ...
        search: Optional[str] = Query(default=None, description="Search in username and email")
) -> PaginatedResponse[ShowUser]:
